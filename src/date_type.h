 ...
 */
static const int TIME_BOOST = 10;
static const int MINUTE_TICKS =  2000 / TIME_BOOST; /// It's not exact this value but this is very good aproximation.
static const int HOUR_TICKS = 120000 / TIME_BOOST;
